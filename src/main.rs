...
fn insert_user(conn: &Connection, user: &str) {
    ...
    match result {
        ...
        Err(e) => panic!("No se pudo insertar el usuario, error: {}", e),
    }
}
...
fn create_table(conn: &Connection) {
    ...
    match result {
        ...
        Err(e) => panic!("No se puedo crear la tabla, error: {}", e),
    }
}
...
fn create_database() -> Connection {
    ...
    match result {
        ...
        Err(e) => panic!("Base de datos no se puede abrir, error: {}", e),
    }
}
